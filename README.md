...
Sistema Integral de Gestión Empresarial con Inventario Inteligente desarrollado con una arquitectura Full Stack utilizando Angular, Node.js, Express.js y MongoDB.
...
```bash
git clone https://github.com/mcerronvelasquez23/Nexus-Inventory.git
```
